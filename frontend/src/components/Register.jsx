...
export default function Register() {
  ...
  function validate() {
    ...
    else if (!PASSWORD_REGEX.test(password)) errs.push('Password must be at least 8 characters and include 1 uppercase, 1 lowercase, 1 digit and 1 special character.')
    ...
    <div className="card" style={{ maxWidth: 480 }}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="tiny" style={{ marginTop: 6 }}>
          Password must be at least 8 chars and include: 1 uppercase, 1 lowercase, 1 digit and 1 special char.
        </div>
